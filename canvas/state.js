...
export function getStateHandler() {
    const state = {
        cards: [],
        dzs: [],
        selectedCard: null,
    ...
    function setCardSelectedIfOver(mousePos) {
    ...
    function setMouseMove(mousePos, canvasWidth, canvasHeight) {
    ...
    function setOverOriginalDropZone() {
        if (state.selectedCard) {
